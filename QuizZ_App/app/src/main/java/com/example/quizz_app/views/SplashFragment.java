...
public class SplashFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if(viewModel.getCurrentUser() != null) { //Ako je logiran ide u igru
                    navController.navigate(R.id.action_fragment_splash_to_fragment_list);
                }else{
                    navController.navigate(R.id.action_fragment_splash_to_fragment_sign_in);
                }
            }
        }, 4000);
    }
